			...
			if (usuario != null && usuario.getPassword().equals(password)){
				...
				switch(entidad){
					...
					case 1: req.getSession().setAttribute("Estudiante", dao.getEstudiante(nick));
							...
							break;
					case 2:	req.getSession().setAttribute("Universidad", dao.getUniversidad(nick));
							resp.sendRedirect("/inicioUni");
							break;
					case 3: req.getSession().setAttribute("Banco", dao.getBanco(nick));
							resp.sendRedirect("/inicioBanco");
							break;
					case 4: req.getSession().setAttribute("Estampadora", dao.getEstampadora(nick));
