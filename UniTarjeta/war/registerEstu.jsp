					...
					<table align="center">
								...
								<table>
									<tr>
										<td>
											...
											<input class="textoNombre" type="text" name="name" id="nombre" value="Nombre" size="5" onBlur="if(this.value == '') this.value = 'Nombre'" onFocus="if(this.value == 'Nombre') this.value = ''" required>
										</td>
										<td>
											<label for="apellido" class="labelNombre">Apellidos</label>
						...
						<tr>
							...
							<td>
								...
								<input class="textoLetra" type="password" name="password" id="contraseña" value="Password" onBlur="if(this.value == '') this.value = 'Password'" onFocus="if(this.value == 'Password') this.value = ''" required>
  
							</td>
							<td>
								<label for="Rcontraseña" class="labelLetra">Repita contraseña</label>
								<input class="textoLetra" type="password" id="rcontraseña" value="Password" onBlur="if(this.value == '') this.value = 'Password'" onFocus="if(this.value == 'Password') this.value = ''" required> 
							</td>
						</tr>
